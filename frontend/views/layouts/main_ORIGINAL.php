    ...
    <div class="container" style="width: 90%">
        <div style="row">
            ...
            <div class="hidden"> <address>
                    <i class="fa fa-envelope-o" aria-hidden="true"></i>&nbsp;kapitan@raketos.ru&nbsp; <i class="fa fa-mobile" aria-hidden="true"></i>&nbsp;8&nbsp;800&nbsp;2000&nbsp;600
                </address> </div>
  ...
  <div class="container">
    ...
    <article class="footer-top">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-3">
                    <section>
                        <header> Свяжитесь&nbsp;с&nbsp;нами </header> Глиссандирующая ритмоформула, следовательно, возможна. Глиссандо заканчивает резкий полиряд.
                        <br>
                        <br> <i class="fa fa-map-marker" aria-hidden="true"></i>&nbsp;Архангельск
                        <br> <i class="fa fa-mobile" aria-hidden="true"></i>&nbsp;8&nbsp;800&nbsp;2000&nbsp;600
                        <br> <i class="fa fa-envelope-o" aria-hidden="true"></i>&nbsp;kapitan@raketos.ru
                        <br> </section>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-3">
                    <section>
                        <header> Прочая&nbsp;информация </header>Спектральная отражательная способность, как того требуют законы термодинамики, повышает супесчаный фрактал.
                        <br>
                        <br> </section>
                </div>
            </div>
    ...
    <article class="footer-bottom">
        <div class="container">
            <div class="row">
                <div class="col-md-5">
                    <section class="raketos-copyright pull-left"> © 2016 Raketos. Все права защищены. </section>
                </div>
                <section>
                    <div class="col-md-7">
