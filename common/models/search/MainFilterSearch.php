...
/**
 * MainFilterSearch represents the model behind the search form about `common\models\forms\MainFilterForm`.
 */
class MainFilterSearch extends MainFilterForm
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['name', 'body', 'engine_type', 'turnover_of_max_power', 'inlet_type', 'cylinder_arrangement', 'fuel_grade', 'front_suspension', 'rear_suspension', 'gearbox_type', 'drive_unit', 'front_brakes'], 'safe'],
