...
/**
 * GeoCountrySearch represents the model behind the search form about `common\models\forms\GeoCountryForm`.
 */
class GeoCountrySearch extends GeoCountryForm
{
    ...
    {
        return [
            [['id', 'phone_number_digits', 'system_measure', 'active'], 'integer'],
