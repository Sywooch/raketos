...
/* @var $model \common\models\forms\InfoForm */

$this->title = 'Полезная информацию';
            ...
            <?= Collapse::widget([
                'items' => [
                    [
                        ...
                        'content' => 'В данном разделе происходит управления рубликой «Полезная информация».<br>
    ...
    <div class="col-md-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                ...
                <?= Html::button('<span class="glyphicon glyphicon-plus"></span> '.Yii::t('app', 'Добавить информацию'), [
                                ...
                                [
                                    ...
                                    'buttons' => [
                                        'update' => function ($url, $model, $key) {
                                            ...
                                            $model = \common\models\forms\InfoForm::findOne($key);
