...
/* @var $searchModel common\models\search\AdsTariffSearch */
            ...
            <?= Collapse::widget([
                'items' => [
                    [
                        ...
                        'content' => 'В данном разделе происходит управление тарифами.<br>
...
<div class="ads-tariff-form-index">
                                ...
                                [
                                    ...
                                    'buttons' => [
                                        'update' => function ($url, $model, $key) {
                                            ...
                                            $model = \common\models\forms\AdsTariffForm::findOne($key);
