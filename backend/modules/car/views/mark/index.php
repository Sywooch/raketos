            ...
            <?= Collapse::widget([
                'items' => [
                    [
                        ...
                        'content' => 'В данном разделе происходит управления рубликой «Марки».<br>
                                ...
                                2. Менять значения строго не рекомендуется.
                            ',
                    ],
                ]]); ?>
        </div>
                                ...
                                [
                                    ...
                                    'buttons' => [
                                        'update' => function ($url, $model, $key) {
                                            ...
                                            $model = \common\models\forms\CarMarkForm::findOne($key);
