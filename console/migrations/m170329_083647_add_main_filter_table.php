...
class m170329_083647_add_main_filter_table extends Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createTable('{{%main_filter}}', [
            ...
            'name'                  => $this->string(10)->unique()->comment(Yii::t('app', 'Метка')),
            'body'                  => $this->string()->unique()->comment(Yii::t('app', 'Кузов')),
        ...
        $this->db->createCommand("COPY {{%main_filter}} FROM '/var/www/setyes/data/www/car.raketos.ru/console/migrations/csv/main_filter.csv'
            WITH (
            FORMAT CSV,
            DELIMITER ';',
            HEADER true
